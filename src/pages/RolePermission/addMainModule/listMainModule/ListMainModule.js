...
import { deleteMainModulee } from "../../../../api/login/Login"


function ListMainModule({ onChangeVal,toatalCount, dmtTtxn, loading, dmtExcelTtxn, getDmtTxnData,page }) {
    ...
    const deleteMainModule = async (id) => {
        try {
            const res = await deleteMainModulee(id)
            getDmtTxnData(page)
        } catch (error) {
                                                    ...
                                                    return <tr role="row" className="odd" key={i}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex">
                                                                ...
                                                                <Link to={`/update-main-module/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1"><i className="fa fa-pencil" /></Link>
                                                                <Popconfirm
                                                                    title="Delete  Main Modules !"
