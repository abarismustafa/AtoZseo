...
function FlightCreditNote() {
    return (
        <>
            <div className="PageHeading">
                <h1>Flight Credit Notes</h1>
            </div>
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                <div className="form-group col-md-4">
                                    ...
                                    <select class="form-select" name="type">
                                        ...
                                        <option value="all">Cr.Number</option>
                                        <option value="debit">First Name</option>
                                        <option value="debit">Ticket Number</option>
                                        <option value="debit">PNR Number</option>
                                        <option value="debit">Date Range</option>
                                    </select>
                                </div>
                                <div className="form-group col-md-4">
                                ...
                                <tbody>
                                    <tr className="odd">
                                        ...
                                        <td style={{ textAlign: 'center' }}>
                                            <p className="pending-css">Pending</p>
                                        </td>
...
export default FlightCreditNote